    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Property "${_title.text.trim()}" created'),
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: const InputDecoration(
                    hintText: 'Unit type name (e.g. Standard 300sqm)',
                    isDense: true,
                  ),
                ),
              ),
          ...
          TextField(
            ...
            decoration: const InputDecoration(
              labelText: 'Notes',
              hintText: 'Optional description for this unit type',
              isDense: true,
            ),
          ),
        ],
